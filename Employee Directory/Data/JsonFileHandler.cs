...
namespace EmployeeDirectory.Data
{
    ...
    {
        public static readonly string RoleFilePath = Path.GetFullPath("../../../Data/role.json");
        public static readonly string EmployeeFilePath = Path.GetFullPath("../../../Data/employee.json");
